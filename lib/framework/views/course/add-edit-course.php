<div class="row">
    <div class="card w-100">
        ...
        <div class="card-header">
            <h5 class="card-title">
                <a href="<?php echo BASE_URL;?>course" class="btn btn-secondary bmd-btn-icon"><i class="material-icons">arrow_back</i></a>&nbsp;
                <?php if (isset($course)) echo "Edit"; else echo "Add"; ?> Course
            </h5>
        </div>
